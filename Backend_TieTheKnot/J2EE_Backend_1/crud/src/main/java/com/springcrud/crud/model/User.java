...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", location=" + location + ", wedding_date=" + wedding_date
	...
	public User(Long id, String name, String location, String wedding_date, String wedding_venue, String decoration,
